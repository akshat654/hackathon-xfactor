...
import com.here.hackathon.xfactor.service.BasicCrawler;
...
public class BasicCrawlController {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> crawlDomains = Arrays.asList("http://stores.vmart.co.in/");
        ...
        controller.addSeed("http://stores.vmart.co.in/");
        ...
        CrawlController.WebCrawlerFactory<BasicCrawler> factory = () -> new BasicCrawler(crawlDomains);
